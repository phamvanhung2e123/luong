...
(function($) {
	...
	FlipClock.DailyCounterFace = FlipClock.Face.extend({
		...
		build: function(excludeHours, time) {
			...
			if(this.showSeconds) {
				$(this.createDivider(null)).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
			}
			else
			{
				offset = 2;
			...
			$(this.createDivider(null)).insertBefore(this.factory.lists[this.factory.lists.length - 4 + offset].$obj);
			$(this.createDivider(null)).insertBefore(this.factory.lists[this.factory.lists.length - 6 + offset].$obj);
			$(this.createDivider(null, true)).insertBefore(this.factory.lists[0].$obj);
